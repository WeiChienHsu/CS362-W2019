...
int playBaron(struct gameState *state,
              int currentPlayer,
              int choice1)
{
...
int playGreatHall(struct gameState *state,
                  int currentPlayer,
                  int handPos)
{
	//+1 Card
...
int playMinion(struct gameState *state,
			   int currentPlayer,
			   int handPos, 
			   int choice1,
			   int choice2,
...
int playSteward(struct gameState *state,
			   int currentPlayer,
			   int handPos, 
			   int choice1,
			   int choice2,
...
int playAmbassador(struct gameState *state,
				   int choice1, 
				   int choice2,
				   int currentPlayer,
				   int handPos)
...
int playCutpurse(struct gameState* state,
				 int currentPlayer,
				 int handPos)
{
